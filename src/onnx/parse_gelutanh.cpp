...
struct parse_gelutanh : op_parser<parse_gelutanh>
{
                          ...
                          std::vector<instruction_ref> args) const
    {
        ...
        auto l3    = info.add_literal(literal{shape{input->get_shape().type(), {1}}, {0.035677408136300125}});
        auto l4    = info.add_literal(literal{shape{input->get_shape().type(), {1}}, {0.79788456080286535588}});
